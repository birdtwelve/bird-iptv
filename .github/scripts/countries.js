    ...
    if (line.startsWith('#EXTINF')) {
      ...
      if (!groups[currentGroupTitle]) {
        groups[currentGroupTitle] = [
          '#EXTM3U',
          '# WARNING: This file is auto-generated from vizio.m3u',
          '# Do not edit this file directly - edit the main playlist instead',
...
if (!filePath) {
  console.error('Please provide the path to vizio.m3u');
  process.exit(1);
}
...
try {
  ...
  console.error('Error splitting vizio.m3u:', error.message);
  process.exit(1);
}
